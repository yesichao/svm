...
class Metrics(Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        self.n=self.n+1
        model.save('D:/python/bwl res_net/model/class_weight_'+str(self.n)+'_net.h5')
...
model_name = 'D:/python/bwl res_net/model/Data_Enhancement'
...
history=model.fit(x=TrainX, y=TrainY, batch_size=128, epochs=60,#class_weight=class_weights,
