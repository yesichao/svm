...
Se=[]
Pp=[]
model_name = 'D:/python/bwl res_net/model/Data_Enhancement1'
class Metrics(Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        if self.n < np.mean(_val_recall):
            ...
            model.save(model_name+'_se_net.h5')
        print("-val_precision:", _val_precision)
        return
metrics = Metrics()

data_path = 'D:/python/bwl res_net/npy_170/'
data_path1 = 'D:/python/bwl res_net/bagging_data/'
# --------------------- 数据载入和整理 -------------------------------
...
for i in range(len(target_class)):
    TrainXt = np.load(data_path1 + train_data[target_class[i]][:-4]+label+".npy")
...
print(TestX.shape)
class_weights = {}
class_weights={0: 1.3411988066178464, 1: 21.406926406926406, 2: 5.1564129301355575, 3: 72.72058823529412}
